    ...
    try:
        ...
        _all_ddl = [
            ...
            """CREATE TABLE IF NOT EXISTS sign_requests (
                ...
                placeholder_page INTEGER DEFAULT 1,
                placeholder_x FLOAT,
                placeholder_y FLOAT,
                placeholder_w FLOAT,
                placeholder_h FLOAT,
            ...
            "ALTER TABLE signoff_documents ADD COLUMN IF NOT EXISTS pdf_path VARCHAR(512)",
            "ALTER TABLE signoff_documents ADD COLUMN IF NOT EXISTS pdf_filename VARCHAR(256)",
            "ALTER TABLE sign_requests ADD COLUMN IF NOT EXISTS placeholder_page INTEGER DEFAULT 1",
            "ALTER TABLE sign_requests ADD COLUMN IF NOT EXISTS placeholder_x FLOAT",
            "ALTER TABLE sign_requests ADD COLUMN IF NOT EXISTS placeholder_y FLOAT",
            "ALTER TABLE sign_requests ADD COLUMN IF NOT EXISTS placeholder_w FLOAT",
            "ALTER TABLE sign_requests ADD COLUMN IF NOT EXISTS placeholder_h FLOAT",
