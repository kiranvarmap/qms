...
import { materialRequirements } from "@/lib/services/production-planning";
...
export async function GET(req: Request) {
  return apiHandler(async () => {
    ...
    return ok({ data: await materialRequirements(workspaceId) });
  }, { route: "GET /api/production-planning/materials" });
}
