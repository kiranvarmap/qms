...
export default function NewCustomerPage() {
  ...
  return (
    <div className="p-8 max-w-5xl mx-auto pb-28">
      ...
      <h1 className="text-[24px] font-semibold tracking-tight text-gray-900 [font-family:var(--font-display)] mb-6">New Customer</h1>
      ...
      <div className="space-y-4">
        ...
        <Row label="Customer Language">
          <NativeSelect value={f.customerLanguage} onChange={(e) => set("customerLanguage", e.target.value)} className={`${inp} max-w-xs`}><option>English</option><option>Hindi</option><option>Spanish</option><option>French</option><option>German</option><option>Arabic</option></NativeSelect>
        </Row>
      </div>
