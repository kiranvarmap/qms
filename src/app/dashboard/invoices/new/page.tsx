  ...
  return (
    <div className="p-8 max-w-6xl mx-auto pb-28">
      ...
      <div className="grid grid-cols-2 gap-x-10 gap-y-4 max-w-4xl">
        ...
        <div />
        <Row label="Invoice Date" required><input type="date" value={h.issueDate} onChange={(e) => setF("issueDate", e.target.value)} className={inp} /></Row>
        <Row label="Due Date"><input type="date" value={h.dueDate} onChange={(e) => setF("dueDate", e.target.value)} className={inp} /></Row>
