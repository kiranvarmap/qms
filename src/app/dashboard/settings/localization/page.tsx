...
import { Globe, Check } from "@vibe/icons";
...
export default function LocalizationSettingsPage() {
  ...
  return (
    <div className="p-8 max-w-3xl mx-auto">
      ...
      <NativeSelect value={workspaceId} onChange={(e) => setWorkspaceId(e.target.value)} className="mb-6 bg-white border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-900">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            ...
            <div className="flex items-end gap-3">
              <label className="block">
                ...
                <NativeSelect value={country} onChange={(e) => setCountry(e.target.value)} className="mt-1 w-64 bg-white border border-gray-300 rounded-md px-3 py-2 text-sm text-gray-900">
