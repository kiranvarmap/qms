...
export default function NewSalesOrderPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-xl font-semibold text-gray-900 mb-6">New Sales Order</h1>
      ...
      <div className="flex justify-end gap-2">
        <Link href="/dashboard/sales-orders" className="px-4 py-2 text-sm text-gray-600 hover:text-gray-900">Cancel</Link>
