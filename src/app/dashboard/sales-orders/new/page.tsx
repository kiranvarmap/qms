...
export default function NewSalesOrderPage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-xl font-semibold text-white mb-6">New Sales Order</h1>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <label className="block">
          <span className="text-xs text-gray-500">Fulfill from warehouse</span>
      ...
      <div className="flex justify-end gap-2">
        <Link href="/dashboard/sales-orders" className="px-4 py-2 text-sm text-gray-400 hover:text-gray-200">Cancel</Link>
