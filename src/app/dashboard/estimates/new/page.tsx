  ...
  return (
    <div className="p-8 max-w-6xl mx-auto pb-28">
      ...
      <div className="grid grid-cols-2 gap-x-10 gap-y-4 max-w-4xl">
        ...
        <div />
        <Row label="Quote Date" required><input type="date" value={h.quoteDate} onChange={(e) => setF("quoteDate", e.target.value)} className={inp} /></Row>
        <Row label="Expiry Date"><input type="date" value={h.expiryDate} onChange={(e) => setF("expiryDate", e.target.value)} className={inp} /></Row>
