...
export default function NewEstimatePage() {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h1 className="text-xl font-semibold text-white mb-6">New Estimate</h1>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <label className="block">
          ...
          <input type="date" value={validUntil} onChange={(e) => setValidUntil(e.target.value)} className="mt-1 w-full bg-gray-950 border border-white/10 rounded-md px-3 py-2 text-sm text-gray-200" />
        </label>
      </div>
      ...
      <div className="flex justify-end gap-2">
        <Link href="/dashboard/estimates" className="px-4 py-2 text-sm text-gray-400 hover:text-gray-200">Cancel</Link>
